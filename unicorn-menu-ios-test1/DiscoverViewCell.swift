...
class DiscoverViewCell: UICollectionViewCell, DiscoverTansitionViewCellProtocol {
    ...
    private func autoLayoutSubviews() {
        ...
        let restaurant_constraint_H = NSLayoutConstraint.constraintsWithVisualFormat("H:|-5-[logoView]-15-[restaurantName]", options: NSLayoutFormatOptions(0), metrics: nil, views: viewsDictionary)
        ...
        let view_constraint_V = NSLayoutConstraint.constraintsWithVisualFormat("V:|-0-[cuisineImage]-5-[cuisineName]-5-[restaurantName]-5-|", options: NSLayoutFormatOptions(0), metrics: nil, views: viewsDictionary)
